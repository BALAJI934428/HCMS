...
const hospitalSchema = new mongoose.Schema({
  ...
  doctors: [{ type: mongoose.Schema.ObjectId }],
...
hospitalSchema.methods.isValidPassword = async function (enteredPassword) {
  return await bcrypt.compare(enteredPassword, this.password);
};
hospitalSchema.methods.getResetToken = function () {
  //Generate Token
...
let schema = mongoose.model("Hospital", hospitalSchema);
